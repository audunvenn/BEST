...
public class Subsumption_WordNet_Matcher extends ObjectAlignment implements AlignmentProcess {
	...
	public Subsumption_WordNet_Matcher() {
	}
	...
	public Map<String, Double> wordNetMatch (Object o1, Object o2) throws AlignmentException, OntowrapException {
		...
		String s1 = StringUtils.stringTokenize(ontology1().getEntityName(o1), true);
		String s2 = StringUtils.stringTokenize(ontology2().getEntityName(o2), true);
